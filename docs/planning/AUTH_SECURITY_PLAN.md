...
model Permission {
  ...
  resource    String    // voter, campaign, team, audit, settings
  action      String    // read, create, update, delete, export
  
  // Role-based assignment
  roles       Role[]
  users       User[]    // For fine-grained overrides
  
  // Constraints (optional)
  precinct    String?   // null = all precincts
  campaign    String?   // null = all campaigns
